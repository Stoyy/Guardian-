...
bot.on("ready", async () => {
  ...
  bot.user.setActivity("Cozymodz.ml", {type: "STREAMING", url: "https://www.twitch.tv/cozy-on-youtube"});
});
...
bot.on('guildMemberAdd', async member => {
  ...
  ctx.fillText(`Welcome, ${member.displayName}`, canvas.width / 5, canvas.height / 2.2);
  
	//ctx.font = applyText(canvas, `${member.displayName}!`);
	ctx.fillStyle = '#000000';
	ctx.fillText(`You are the ${member.guild.memberCount} Member.`, canvas.width / 5, canvas.height / 1.5);
...
if (message.channel.type == "dm") return;
   ...
   if (Link.some(Link => message.content.toLowerCase().includes(Link))) {
       ...
       let m = new RichEmbed()
        ...
        log.setTimestamp()
        channel = message.guild.channels.find(channel => channel.name === '📰・audit-log');
...
if (message.content.startsWith(prefix + "verify")) {
  ...
  if (message.channel.name !== '✅・verify') return message.channel.send({embed: {
    color:  3553599,
    description: `**${message.author} You must go to the channel #✅・verify`,
    footer: {
    text: `${message.author.tag} with ID: ${message.author.id} tried verification in #${message.channel.name}...`
        ...
        message.channel.send(Process).then(Process => { Process.delete(1500);});
          ...
          if(message.author.id == b1) return message.channel.send({embed: {
            ...
            footer: {
            text: `If you'd like to appeal to be whitelisted please contact, a staff member`
              }
          }});
...
let role = message.mentions.roles.first() || message.guild.roles.get(args[0]) || message.guild.roles.find(role => role.name === args[0]);
    ...
    const embed = new RichEmbed()
        ...
        .setFooter(`Developed by Cozy#9999 For ${message.guild.name} Server`, bot.user.avatarURL)
...
if (message.content.startsWith(prefix + "remind")) {
  ...
  let remindEmbed = new Discord.RichEmbed()
      ...
      .setFooter(`Developed by Cozy#9999 `, message.guild.avatarURL)
      .setTimestamp();
  ...
  setTimeout(function() {
      let remindEmbed = new Discord.RichEmbed()
          .setColor('RANDOM')
          .setAuthor(`${message.author.username}`, message.author.displayAvatarURL)
          .setFooter(`Developed by Cozy#9999 `)
          .setDescription(`**Reminder: ${reminder}**`)
          .setTimestamp()
...
if (message.content.startsWith(`${prefix}nsfw`)) {
  ...
  .setThumbnail("https://media.discordapp.net/attachments/785262802427314218/797021176857624596/Cozylogo.png")
...
if (message.content.toLowerCase().startsWith(prefix + `help`)) {
  ...
  .setFooter(`Developed by Cozy#9999 For ${message.guild.name} Server`)
  message.channel.send({ embed: embed });
}
...
if (message.channel.name !== '🤖・commands') return message.channel.send({embed: {
    color: 3553599,
    description: `${message.author} You must go to the channel **#🤖・commands**.`
 }}); 

const reason = message.content.split(" ").slice(1).join(" ");

if (!message.guild.roles.exists("name", "🚨 |  Staff")) return message.channel.send(`This server doesn't have a \`🚨 |  Staff\` role, so the ticket won't be opened.\nIf you are an administrator, make one with that name exactly and give it to users that should be able to see tickets.`);
...
if (message.guild.channels.exists("name", "ticket-" + message.author.id)) return message.channel.send({embed: {
  ...
  message.guild.createChannel(`ticket-${message.author.id}`, "text").then(c => {
      ...
      const embed = new Discord.RichEmbed()
      .setColor("RANDOM")
      .setDescription(`Hey ${message.author} Please try explain why you opened this ticket with as much detail as possible. Our **Staff Team** will be here soon to help.`)
      .setTimestamp();
      c.send({ embed: embed })
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  if(cmd === `${prefix}ban`){
    ...
    let banEmbed = new Discord.RichEmbed()
      ...
      let incidentchannel = message.guild.channels.find(`name`, "📰・audit-log");
      if(!incidentchannel) return message.channel.send("**Can't find `📰・audit-log` channel.**");
...
if(cmd === `${prefix}servinfo`){
  ...
  .setDescription("You can join my server for help [here](https://discord.gg/Uy8wRfB).")
  .setColor('RANDOM')
  .setThumbnail("https://media.discordapp.net/attachments/785262802427314218/797021176857624596/Cozylogo.png")
  ...
  .setFooter(`Developed by Cozy#9999For ${message.guild.name} Server`, bot.user.avatarURL)
  .setTimestamp()
...
if (message.content.startsWith(prefix + 'botinfo')) {
  ...
  .setAuthor(bot.user.username, `${bot.user.avatarURL}`)
  .setColor("RANDOM")
  .addField(`Main Developer`, `**➥** Cozy#9999`, true)
  .addField(`Awesome helpers`, `**➥** I SUCK AT LIFE#1337`, true)
  ...
  .setThumbnail("https://media.discordapp.net/attachments/785262802427314218/797021176857624596/Cozylogo.png", true)
  .setDescription('You can join my server for help [here](https://discord.gg/EgsadEUzVQ).')
  .setFooter(`Developed by Cozy#9999 For ${message.guild.name} Server`, bot.user.avatarURL)
  .setTimestamp()
  return message.channel.send({embed});
}
...
bot.on("channelCreate", async channel => {
	var logs = channel.guild.channels.find(c => c.name === '📰・audit-log');
